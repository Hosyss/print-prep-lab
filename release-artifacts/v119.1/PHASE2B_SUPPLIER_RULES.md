...
If at least one supplier is explicitly Eligible, `best` must itself be explicitly Eligible. Otherwise the supplier summary is INVALID rather than silently choosing an ineligible provider.
